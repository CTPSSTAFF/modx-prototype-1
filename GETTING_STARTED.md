...
_Note_: Be sure to use __forward__ (rather than backward) slashes in all path names.
...
jupyter notebook
```
4. When these steps have completed, a new tab will open in your default web browser.
