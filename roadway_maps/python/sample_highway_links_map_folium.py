...
# Name of CSV file with volume, V/C, and speed data for selected links that was generated by
# the notebook "sample_highway_links_report.ipynb."
# This will now be our *input* CSV file.
# NOTE: We're using a superset of the links supplied by Drashti.
csv_fn = 'links_superset_report_base_scenario.csv'
